...
\begin{figure}[h]
\centering
\fbox{\includegraphics[width=0.8\textwidth]{RayTraceSchematic}}
...
\begin{figure}[h]
\centering
\fbox{\includegraphics[width=0.8\textwidth]{single_leaf_single_shadow}}
...
\begin{figure}[h]
\centering
\fbox{\includegraphics[width=0.8\textwidth]{all_together}}
