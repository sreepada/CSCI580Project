...
function checkIfInsideTriangle(point, vertex0, vertex1, vertex2) {
    ...
    var areaWithoutV2 = Math.abs(vertex0[0] * (point[1] - vertex1[1]) + vertex1[0] * (vertex0[1] - point[1]) + point[0] * (vertex1[1] - vertex0[1]));
    //var w0 = areaWithoutV0 / areaOfTriangle;
    //var w1 = areaWithoutV1 / areaOfTriangle;
    //var w2 = areaWithtouV2 / areaOfTriangle;

    //var crossOfTriangle = crossProduct1D(
    //                    subtractVectors(vertex1, vertex0),
    //                    subtractVectors(vertex2, vertex0));

    //var areaOfTriangle = Math.sqrt(crossOfTriangle[0] * crossOfTriangle[0] + crossOfTriangle[1] * crossOfTriangle[1] + crossOfTriangle[2] * crossOfTriangle[2])/2;

    //var crossWithoutV0 = crossProduct1D(
    //                    subtractVectors(vertex1, point),
    //                    subtractVectors(vertex2, point));
    //var areaWithoutV0 = Math.sqrt(crossWithoutV0[0] * crossWithoutV0[0] + crossWithoutV0[1] * crossWithoutV0[1] + crossWithoutV0[2] * crossWithoutV0[2])/2;

    //var crossWithoutV1 = crossProduct1D(
    //                    subtractVectors(point, vertex0),
    //                    subtractVectors(vertex2, vertex0));
    //var areaWithoutV1 = Math.sqrt(crossWithoutV1[0] * crossWithoutV1[0] + crossWithoutV1[1] * crossWithoutV1[1] + crossWithoutV1[2] * crossWithoutV1[2])/2;

    //var crossWithoutV2 = crossProduct1D(
    //                subtractVectors(vertex1, vertex0),
    //                subtractVectors(point, vertex0));
    //var areaWithoutV2 = Math.sqrt(crossWithoutV2[0] * crossWithoutV2[0] + crossWithoutV2[1] * crossWithoutV2[1] + crossWithoutV2[2] * crossWithoutV2[2])/2;

    var w0 = areaWithoutV0 / areaOfTriangle;
    var w1 = areaWithoutV1 / areaOfTriangle;
    var w2 = areaWithoutV2 / areaOfTriangle;
...
function rayTraceTriangle(triangleVectors, camN, camPos, camU, camV, rayEtoO) {
